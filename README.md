...
For doing different experiments change the model type like (RF, DDIMDL, CNN, etc) in main function and also change the features of drugs like enzymes, targets etc or combination of features enzymes + target.
